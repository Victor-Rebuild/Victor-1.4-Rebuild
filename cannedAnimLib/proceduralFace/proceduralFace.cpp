...
const int ProceduralFace::NominalEyeHeight = Factory::IsXray() ? 50 : 57;
const int ProceduralFace::NominalEyeWidth = Factory::IsXray() ? 38 : 43;
...
# define CONSOLE_GROUP "Face.ParameterizedFace"
  ...
  CONSOLE_VAR_RANGED(s32, kProcFace_NominalEyeSpacing, CONSOLE_GROUP, Factory::IsXray() ? 83 : 92, -FACE_DISPLAY_WIDTH, FACE_DISPLAY_WIDTH);  // V1: 64;
