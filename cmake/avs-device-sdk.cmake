...
if (VICOS)
  set(LIBAVS_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/deps/avs-device-sdk/vicos/include")
  set(LIBAVS_LIB_PATH "${ANKI_EXTERNAL_DIR}/deps/avs-device-sdk/vicos/lib")
elseif (MACOSX)
  set(LIBAVS_INCLUDE_PATH "${ANKI_EXTERNAL_DIR}/deps/avs-device-sdk/mac/include")
  set(LIBAVS_LIB_PATH "${ANKI_EXTERNAL_DIR}/deps/avs-device-sdk/mac/lib")
endif()
